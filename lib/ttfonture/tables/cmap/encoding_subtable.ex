defmodule TTFonture.Tables.Cmap.EncodingSubtable do
  ...
  @type t() :: %__MODULE__{platform_id: non_neg_integer(), platform_specific_id: non_neg_integer(), offset: non_neg_integer()}
  ...
  def read(file) do
      ...
      %__MODULE__{platform_id: platform_id, platform_specific_id: platform_specific_id, offset: offset}
  end
end
